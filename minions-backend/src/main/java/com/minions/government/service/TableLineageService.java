package com.minions.government.service;

import com.minions.government.bean.SourceTarget;
...
public class TableLineageService {
    ...
    private static final String[] SQLS = {
            "INSERT INTO gmall.tableOne SELECT id, name FROM gmall.tableTwo JOIN gmall.tableThree ON gmall.tableTwo" +
                    ".id = gmall.tableThree.id",
            "INSERT INTO gmall.tableTwo SELECT id, name FROM gmall.tableFour JOIN gmall.tableFive JOIN gmall.tableSix" +
                    " ON gmall.tableFour.id = gmall.tableFive AND gmall.tableFive.pid = gmall.tableSix.pid"
    };
